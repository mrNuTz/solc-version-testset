...
contract PeripheryImmutableState is IPeripheryImmutableState {
    ...
    constructor(address _factory, address _WETH9) internal {
        factory = _factory;
        WETH9 = _WETH9;
    }
}
...
/// @title Creates and initializes V3 Pools
contract PoolInitializer is IPoolInitializer, PeripheryImmutableState {
...
contract ERC721Permit is BlockTimestamp, ERC721, IERC721Permit {
...
contract LiquidityManagement is IUniswapV3MintCallback, PeripheryImmutableState, PeripheryPayments {
